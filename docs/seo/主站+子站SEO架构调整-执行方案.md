...
> ⚠️ 本文件记录的是 2026-04 的“单子站试跑阶段”执行方案。当前标准已升级为“多候选子站矩阵 + 单站 7 仓位起步”，请优先参考 [SEO流量战略.md](./SEO流量战略.md)、[候选子站登记表.md](./候选子站登记表.md) 和 [单站7仓位排期模板.md](./单站7仓位排期模板.md)。本文件中的 `SITE_ID=8` 仅代表当时的试跑站 A 样例。
