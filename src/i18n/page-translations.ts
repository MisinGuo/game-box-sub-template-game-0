...
export const boxPageTranslations: TranslationMap = {
  'zh-CN': {
    ...
    downloadNow: '立即下载', androidDownload: 'Android 下载', iosDownload: 'iOS 下载', sourceDownload: '源站下载', noDownload: '暂无下载',
    features: '特色功能',
  ...
  'zh-TW': {
    ...
    downloadNow: '立即下載', androidDownload: 'Android 下載', iosDownload: 'iOS 下載', sourceDownload: '源站下載', noDownload: '暫無下載',
    features: '特色功能',
  ...
  'en-US': {
    ...
    downloadNow: 'Download Now', androidDownload: 'Android Download', iosDownload: 'iOS Download', sourceDownload: 'Source Download', noDownload: 'No Download Available',
    features: 'Features',
